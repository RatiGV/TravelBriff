        ...
        <div class="x_content">
            <div class="" role="tabpanel" data-example-id="togglable-tabs">
                ...
                >
                    ...
                    <div id="myTabContent" class="tab-content">
                        ...
                        @forelse($main_columns as $main_column)
                            <div class="form-group {{ $errors->has($main_column) ? 'bad' : '' }}">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">
                                    @lang('admin.' . $main_column) <span class="required">*</span>
                                </label>
                                <div class="col-md-7 col-sm-7 col-xs-12">
                        ...
                        <div class="form-group {{ $errors->has('image') ? 'bad' : '' }}">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">
                                @lang('admin.image') <span class="required">*</span>
                            </label>
                            <div class="col-md-7 col-sm-7 col-xs-12">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12"> @lang('admin.main_page')</label>
                        <div class="col-md-7 col-sm-7 col-xs-12">
                            <input type="checkbox" class="flat" name="main_page" />
                        </div>
                    </div>
                    <div class="ln_solid"></div>
                    @endif
