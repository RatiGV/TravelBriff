...
<html lang="en">
    <head>
        ...
        <link href="/Administrator/vendors/mjolnic-bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css" rel="stylesheet">
                    ...
                    <div class="left_col scroll-view">
                        <div class="navbar nav_title" style="border: 0;">
                            <a  href="{{ route('AdminMainPage') }}" class="site_title">
                                <img class="logoAdmin"
                                     id="admin-logo-bg"
                                     src="{{ $information ? $information->logo : '' }}"
                        ...
                        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                            <div class="menu_section">
                                <ul class="nav side-menu">
                                    ...
                                    <li>
                                        <a href="{{ route('EditTextpages',1) }}" title="@lang('admin.routes.Textpages')">
