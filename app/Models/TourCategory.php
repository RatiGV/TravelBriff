...
class TourCategory extends Model
{
    ...
    private static $translates_class = \App\Models\TourCategoryTranslate::class;
    ...
    {
        return $this->hasMany(\App\Models\Tour::class, 'category_id','id')->where('status', 1);
    }

    public function translate()
    {
        return $this->hasOne(TourCategoryTranslate::class,'parent_id','id')->where('lang',locale());
    }
        ...
        if (property_exists(__CLASS__, 'translates_table')) {
            return self::$current_class::join(self::$translates_table, self::$main_table.'.id', '=', self::$translates_table.'.parent_id')
                ...
                ->when($level, function ($query, $level) {
                    return $query->where(self::$main_table.'.level', $level);
                })
    ...
    {
        return $this->hasMany(\App\Models\TourCategory::class, 'parent_id');
    }

    public function parent(): BelongsTo
    {
        return $this->belongsTo(\App\Models\TourCategory::class, 'parent_id', 'id');
    }
}
