...
class ServicesController extends BaseController
{
    ...
    */
    ...
    public function __construct(Service $model)
    {
        ...
        $this->model = $model;
        $this->routes_suffix = 'Services';
        $this->views_folder = 'Administrator.services';
        $this->main_table = 'services';
        $this->translates_table = 'services_translates';
        $this->image_gallery_table = 'services_photos';
    }
