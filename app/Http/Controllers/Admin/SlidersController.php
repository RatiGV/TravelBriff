...
class SlidersController extends BaseController
{
    ...
    private $views_folder; // წარმოდგენების ფაილების საქაღალდე
    ...
    */
    ...
    public function __construct(Slider $model)
    {
        ...
        $this->model = $model;
        $this->routes_suffix = 'Sliders';
        $this->views_folder = 'Administrator.sliders';
        $this->main_table = 'sliders';
        $this->translates_table = 'sliders_translates';
    }
