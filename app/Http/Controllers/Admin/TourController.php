...
class TourController extends BaseController
{
    ...
    */
    ...
    public function __construct(Tour $model)
    {
        ...
        $this->model = $model;
        $this->routes_suffix = 'Tours';
        $this->views_folder = 'Administrator.tours.tours';
        $this->main_table = 'products';
        $this->translates_table = 'products_translates';
        $this->image_gallery_table = 'products_photos';
        $this->categories_model = \App\Models\TourCategory::class;
    }
    ...
    protected $required_columns = ['title', 'short_description', 'description', 'price'];
    ...
    public function index(Request $request)
    {
        ...
        $this->data['listing_columns'] = ['sort', 'status', 'image', 'title', 'price', 'days', 'nights'];
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->stay) {
            ...
            return redirect()->to('/admin/tours/tours?page='.$request->page);
        }
    }
    ...
    public function live_search(Request $request)
    {
        if ($request->ajax()) {
            ...
            if (count($ids_by_title)) {
                $products = Tour::allItems(App::getlocale(), $status_on = false, $ids_by_title, $where_in_cat = false, $paginate = false, $get = true);
            } else {
                $products = collect();
            }
    ...
    public function upload(Request $request)
    {
        ...
        if (in_array($ext, $extensions)) {
            ...
            Excel::import(new TourImport, $path);
