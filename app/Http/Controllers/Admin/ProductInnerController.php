...
class ProductInnerController extends BaseController
{
    ...
    */
    ...
    public function __construct(ProductComponent $model)
    {
        ...
        $this->model = $model;
        $this->routes_suffix = 'ProductInner';
        $this->views_folder = 'Administrator.products.products.products-inner';
        $this->main_table = 'product_components';
        $this->translates_table = 'product_component_translates';
    }
    ...
    protected $required_columns = ['title', 'short_description', 'description', 'image'];
    ...
    public function index(Request $request)
    {
        ...
        $this->data['items'] = $this->model::allItems($this->configuration->admin_lang, $status_on = false, false, $paginate = true, $get = false);


        $this->data['listing_columns'] = ['sort', 'status', 'image', 'title'];
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->stay) {
            ...
            return redirect()->to('/admin/products/template-inner?page='.$request->page);
        }
    }
}
