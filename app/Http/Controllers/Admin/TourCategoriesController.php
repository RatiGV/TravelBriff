...
class TourCategoriesController extends BaseController
{
    ...
    */
    ...
    public function __construct(TourCategory $model)
    {
        ...
        $this->model = $model;
        $this->routes_suffix = 'TourCategories';
        $this->views_folder = 'Administrator.tours.categories';
    ...
    public function index()
    {
        ...
        $this->data['items'] = $this->model->allItems($this->configuration->admin_lang, false, false, false);
